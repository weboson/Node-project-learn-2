...
// 1) Реализация сервера НАТИВНЫМИ средствами Nodejs (без фрейворков), со СТАТИЧЕСКОЙ передачей данный (html-страницы) - файл: static-app.js
...
// 1) GET - ПОЛУЧИТЬ запроса от сайта (далее сервер может ответить отправив данные на ПОЛУЧЕННЫЙ запрос)
